...
// TODO: 1. we can only find new gaps at the end of pages
// TODO: 2. don't allocate full pages right away, don't allocate on start
// TODO: 3. when appending to pages, we should expand them
// TODO: 4. we can not modify pages in-place, always write to new page
// TODO: 5. we can only append to mappings
    ...
    S: UniversalWrite + 'static,
{
    Dynamic {
        ...
        /// 0 is free, 1 is used.
        ///
        /// TODO: missing in serverless? we just create file and assume all absent bits are 1?
...
impl<V, S: UniversalWrite + 'static> Gridstore<V, S> {
    ...
    fn flusher_serverless(&self) -> Flusher {
        ...
        Box::new(move || {
            ...
            // TODO: in serverless we don't flush free blocks?
            // TODO: Self::flush_free_blocks(&bitmask, old_pointers, block_size_bytes)?;
...
/// Operating mode
// TODO: deduplicate this versus StorageEngine enum
#[derive(Copy, Clone, Eq, PartialEq, Debug, Default)]
pub enum Mode {
    // TODO: remove default variant
    Regular,
    #[default]
    Serverless,
}
